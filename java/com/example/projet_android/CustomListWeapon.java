...
/**
 * Custom adapter for a list of weapons
 * @author MARCHAL ESTRADA SAVE
 * @version 1
 */
public class CustomListWeapon extends BaseAdapter {
    private final WeaponList listData;
    private final LayoutInflater layoutInflater;
    private final Context context;
    public CustomListWeapon(Context aContext, WeaponList listData) {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        img.setImageResource(listData.get(i).getImage());
        return layoutItem;
    }
}
